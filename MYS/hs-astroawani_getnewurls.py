...
sitemap_base = 'https://www.astroawani.com/sitemap/article-'
...
for url in final_result:
    if url:
        ...
        try:
            ...
            # # Get Main Text:
            try:
                soup.find_all('div', {'class' : 'article-text new-line'})
                maintext = ''
                for i in soup.find_all('div', {'class' : 'article-text new-line'}):
                    maintext += i.text
            except:
                try:
