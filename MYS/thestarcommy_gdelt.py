...
class GdeltDownloader:
    ...
    def __init__(self, uri, num_cpus):
        ...
        # self.source_domains = self.db.sources.distinct('source_domain', filter={'include' : True, 'primary_location' : {'$in' : ['GEO', 'UKR', 'ZMB', 'ZWE']}})
        self.source_domains = ['thestar.com.my']
    ...
    def parse_file(self, gdelt_url):
        ...
        try:
            ...
            # self.missing_domains = self.db.sources.distinct('source_domain', filter={'include' : True})
