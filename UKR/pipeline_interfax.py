...
#     try:
#         #### change url pattern
#         # page_url = f'https://interfax.com.ua/news/{keyword}-{page}.html'
#         page_url = f'https://interfax.com.ua/news/{keyword}-{page}.html'
#         headers = {'User-Agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/50.0.2661.102 Safari/537.36'}
...
#         page_soup = BeautifulSoup(page_req.content, features="lxml")
#         print(page_soup)
#         for i in page_soup.find_all('a', {'class':"article-link"}):
#             link = 'https://interfax.com.ua' + i['href']
...
def collect_urls_keyword(keyword, page):
    ...
    try:
        ...
        print(f'ERROR !!! collecting urls ----------- {page}: {e}')
