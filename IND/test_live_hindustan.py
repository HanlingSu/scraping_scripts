...
def collect_urls_keyword(keyword, page):
    ...
    try:
        #### change url pattern
        page_url = f'https://www.livehindustan.com/{keyword}/news-{page}'
        page_req = requests.get(page_url,headers=headers)
        page_soup = BeautifulSoup(page_req.content, features="lxml")
        for i in page_soup.find_all('a', {'class':"card-sm"}):
            link = 'https://www.livehindustan.com/' + i['href']
...
def pipeline(sitemap,
    ...
    if keyword:
        ...
        keywords = [("uttar-pradesh",6500), ("bihar",3500), ("ncr",3000), ("uttarakhand",2000),("jharkhand",1500), ("madhya-pradesh",1500),
                     ("rajasthan",1000), ("chhattisgarh",1000), ("haryana",1000), ("himachal-pradesh",1000), ("maharashtra",1000), ("punjab",1000), 
                     ("jammu-and-kashmir",1000), ("odisha",1000), ("west-bengal",1000),("chandigarh",1000),("tripura",1000),("gujarat",1000),
                     ("national",6500), ("international",2000), ("business",2500), ("career",3000)]
        #"bihar","https://www.livehindustan.com/ncr/news-",
