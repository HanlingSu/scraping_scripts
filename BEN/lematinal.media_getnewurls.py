...
direct_URLs = []
sitemap_base = 'https://lematinal.media/post-sitemap'
source = 'lematinal.media'
...
for url in final_result[::-1]:
    if url:
        ...
        try:
            ...
            if category in ['Sports', 'Football', 'Turf', 'Lifestyle', 'Arts', 'Culture', 'Lifestyle']:
            ...
            if category not in ['Sports', 'Football', 'Turf', 'Lifestyle', 'Arts', 'Culture', 'Lifestyle']:
