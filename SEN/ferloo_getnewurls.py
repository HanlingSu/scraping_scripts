...
This script updates ferloo.com using sitemaps and queries per section. 
...
## Custom Parser
def ferloocom_story(soup):
    """
    Function to pull the information we want from ferloo.com stories
...
# url = "https://www.ferloo.com/post-sitemap19.xml"
...
#sections = ['politique','societe']
#number = ['2','2']
sections = ['politique','societe','economie','international','international/afrique/']
number = ['8','6','6','4','4']
...
for sect in sections:
    ...
    for i in range(1,int(numberx)+1):
        if i == 1:
            url = "https://www.ferloo.com/category/" + sect + "/"
        else:
            url = "https://www.ferloo.com/category/" + sect + "/page/" + str(i) + "/"
...
blpatterns = ['/wp-json/', '/photo/', ':80/', '/art/', '/index.php/', '/wp-content/', '/images/','/category/']
        ...
        if url == None:
            ...
            if "ferloo.com" in url:
                ...
                try:
                    ...
                    article['source_domain'] = 'ferloo.com'
