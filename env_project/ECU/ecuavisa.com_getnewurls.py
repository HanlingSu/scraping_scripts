...
source = 'ecuavisa.com'
direct_URLs = set()
base_url = 'https://www.ecuavisa.com/noticias/medio-ambiente#.p:'
...
# 
    for i in soup.find_all('div', {'class' : 'headline'}):
        a_tag = i.find('a')
...
direct_URLs = ['https://www.ecuavisa.com' + i for i in direct_URLs]
