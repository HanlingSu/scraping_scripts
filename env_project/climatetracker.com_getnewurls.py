...
source = 'climatetracker.com'


categories= ['https://climatetracker.asia/category/stories/page/', 'https://climatetrackerlatam.org/historias/?e-page-857ab59=']
page_start = [1, 1]
page_end = [25, 25]
...
for c, ps, pe in zip(categories, page_start, page_end):
    for i in range(ps, pe+1):
        ...
        try:
            items = soup.find_all('h2', {'class' : 'elementor-heading-title elementor-size-default'})
            for item in items:
                direct_URLs.append(item.find('a')['href'])
        except:
            items = soup.find_all('h1', {'class' : 'elementor-heading-title elementor-size-default'})
            for item in items:
                direct_URLs.append(item.find('a')['href'])
