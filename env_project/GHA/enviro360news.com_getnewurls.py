...
source = 'enviro360news.com'
direct_URLs = set()
categories = ['natural-resources', 'waste-sanitation', 'water', 'energy', 'climate', 'green-tech', 'circular', 'legislation']
pages = (4, 2, 2, 2, 2, 2, 2, )
# for c, p in zip(categories, pages):

for c, max_p in zip(categories, pages):
    for p in range(1, max_p + 1): 
        link = 'https://hungarytoday.hu/category/society/environment/page' + str(c) + '/page/' + str(p) + '/'
