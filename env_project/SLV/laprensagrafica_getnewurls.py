...
final_result = pd.read_csv("Downloads/peace-machine/peacemachine/getnewurls/env_project/SLV/laprensagrafica.csv")['0']
...
for url in final_result:
    if url:
        ...
        try:
            ...
            try:
                date = soup.find('span', {'class': 'published'}).text
                print(date)
