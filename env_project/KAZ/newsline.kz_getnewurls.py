...
""" 
593 = Energy industry - 566
661 = Agriculture - 1533
592 = Oil and Gas Sector - 5258
617 = Power Energy - 35
595 = Metals and Minerals - 2240
""" 

# for c, max_p in zip(categories, pages):
#    for p in range(1, max_p + 1):
#        link = 'https://newsline.kz/section/' + str(c) + '/?SECTION_ID=661&PAGEN_1=' + str(p)
for p in range(1, 1500):
    link = 'https://newsline.kz/section/595/?SECTION_ID=661&PAGEN_1=' + str(p)
