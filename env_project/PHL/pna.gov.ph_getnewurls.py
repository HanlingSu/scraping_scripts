...
for p in range(1, 46):
    link = 'https://www.pna.gov.ph/categories/environment?p=' + str(p)
    ...
    for i in soup.find_all('h2', {'class':'text-2xl font-semibold mb-2'}):
...
for url in final_result:
    if url:
        ...
        try:
            ...
            # Extract date 
            try: 
                date = soup.find('span', {'class': 'block'}).text.strip()
