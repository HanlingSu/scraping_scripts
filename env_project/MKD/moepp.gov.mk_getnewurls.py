...
source = 'moepp.gov.mk'
direct_URLs = set()
base_url = 'https://www.moepp.gov.mk'

for p in range(1, 25): 
    link = 'https://www.moepp.gov.mk/medija/novosti?page=' + str(p) 
...
for url in final_result:
    if url:
        ...
        try:
            ...
            # Extract date
            try:
                date = soup.find('div', class_='field field--name-published-at field--type-published-at field--label-hidden field__item').text.strip()
