...
source = 'iedafrique.org'
direct_URLs = set()
base_url = 'https://www.iedafrique.org/'

for p in range(0, 200, 20):
    link = 'https://www.iedafrique.org/-Actualites-.html?debut_art=' + str(p) + '#pagination_art'
    ...
    for i in soup.find_all('div', {'class':'mtm'}):
        a_tag = i.find('a')
...
for url in final_result:
    if url:
        ...
        try:
            ...
            # Extract date 
            try:
                date = soup.find('p', {'class': 'info-publi'}).text.strip()
