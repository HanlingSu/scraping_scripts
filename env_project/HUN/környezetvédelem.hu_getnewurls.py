...
source = 'környezetvédelem.hu'
direct_URLs = set()
base_url = 'https://xn--krnyezetvdelem-jkb3r.hu/'

for p in range(1, 3): 
    link = 'https://xn--krnyezetvdelem-jkb3r.hu/hirek?page=' + str(p) 
    ...
    for i in soup.find_all('h2', {'class':'node__title'}):
        a_tag = i.find('a')
...
for url in final_result:
    if url:
        ...
        try:
            ...
            # Extract date 
            try: 
                date = soup.find('div', {'class': 'node__meta'}).text.strip()
