...
source = 'greenfund.rw'
direct_URLs = set()
base_url = 'https://greenfund.rw'

for p in range(1, 12):
    link = 'https://greenfund.rw/blog?page=' + str(p)
    ...
    for i in soup.find_all('div', {'class':'post-title'}):
        a_tag = i.find('a')
...
for url in final_result:
    if url:
        ...
        try:
            ...
            # Extract date 
            try:
                date = soup.find('span', {'class': 'post-created'}).text.strip()
