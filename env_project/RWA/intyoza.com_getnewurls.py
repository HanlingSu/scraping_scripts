...
for p in range(1, 16):
    link = 'https://www.intyoza.com/category/ubukungu/ubuhinzi/page/' + str(p)
    ...
    for i in soup.find_all('span', {'class':'title-span'}):
...
for url in final_result:
    if url:
        ...
        try:
            ...
            try:
                maintext = soup.find('div', {'class': 'content-container'}).text
                article['maintext'] = maintext.strip()
            except: 
                maintext = ""
                for i in soup.find('div', {'class': 'content-container'}).find_all('p'):
                    maintext =+ i.text
                    article['maintext'] = maintext.strip()
