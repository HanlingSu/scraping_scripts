...
base = 'https://onecitizendaily.com/index.php/category/news/'
source = 'onecitizendaily.com'
    ...
    for url in final_result:
        if url:
            ...
            try:
                ...
                try:
                    maintext = ''
                    for i in soup.find('div', {'class' : 'entry-content'}).find_all('p')[1:]:
                        if "By" in i.text:
                            pass
                        else:
                            maintext.append(i.text)
