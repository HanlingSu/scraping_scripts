...
direct_URLs = []
sitemap_base = 'https://www.faceofmalawi.com/post-sitemap'
for i in range(83, 84+1):
...
for url in final_result:
    if url:
        ...
        try:
            ...
            blacklist = ['Entertainment', 'Bizarre', 'Music', 'Sports']
            
            if any(x in blacklist for x in category):
                article['date_publish'] = None
                article['maintext'] = None
                article['title'] = "From uninterested category: " + category[0]
                print(article['title'])
            else:
