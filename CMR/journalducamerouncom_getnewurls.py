...
categories = ['politique', 'eco-et-business', 'international', 'sante/actualite', 'dossiers/focus', 'societe/societe-societe']
base = 'https://www.journalducameroun.com/category/'
page_start = [1, 1, 1, 1, 1, 1]
page_end = [3,3,2,1,1, 2]
...
for c, ps, pe in zip(categories, page_start, page_end):
    for p in range(ps, pe +1):
        ...
        for i in soup.find_all('div', {'class' : 'item-content'}):
            try:
                direct_URLs.append(i.find('h3').find('a')['href'])
            except:
                pass
        print('Now scraped ', len(direct_URLs), 'articles from previous pages ... ')
        

# base = 'https://journalducameroun.com/wp-sitemap-posts-post-'
