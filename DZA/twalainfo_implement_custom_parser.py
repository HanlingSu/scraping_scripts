...
class UpdateDB:
    ...
    def __init__(self, col_to_scrape = None,
        ...
        Date: 20 April 2021
        Modified by Diego Romero (Dec 22, 2023)
        '''
    ...
    def twalainfo_story(self, soup):
        """
        Function to pull the information we want from twala.info stories
    ...
    def update_db(self, l, yr, mo):
        ...
        for url,id in tqdm(lines):
            ...
            try:
                d['maintext'] = self.twalainfo_story(soup)['maintext'] #change
            ...
            #try:
            #    d['title'] = self.twalainfo_story(soup)['title'] #change
            #except:
            #    d['title'] = None
            ...
            try:
               d['date_publish'] = self.twalainfo_story(soup)['date_publish'] #change
            except:
               d['date_publish'] = None
