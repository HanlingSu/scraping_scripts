...
for i in range(104, 107): # the higher the sitemap number is, the more recent the content is.
...
for url in final_result:
    if url:
        ...
        try:
            ...
            # fix date
            try:
                date = soup.find('p', {'class' : 'article--single__date dib color--lgray'}).text
