...
def pipeline(sitemap,
    ...
    list_year = []
    list_month = []
    df = pd.read_excel("/home/mlp2/Downloads/peace-machine/peacemachine/getnewurls/TUR/posta_urls.xlsx")
    urls1= list(df[0])
    print(urls1)
    ...
    if keyword:
        ...
        start_date = datetime(2023, 3, 2, tzinfo=pytz.UTC)
        end_date = datetime(2023, 6, 10, tzinfo=pytz.UTC)
