...
This script updates 'aravot.am' using sitemaps.
...
for j in range(initialsitemap,finalsitemap+1):
    ...
    url = 'https://www.aravot.am/wp-sitemap-posts-post-' + str(j) + '.xml'
            ...
            if url == None:
                ...
                if 'aravot.am' in url:
                    ...
                    try:
                        ...
                        article['source_domain'] = 'aravot.am'
                        article['language'] = 'hy'
                        ...
                        if article['maintext'] == None:
                            try:
                                maintext =soup.find("div", {"class":"single-entry-summary-post-content"}).text
                        ...
                        ## Fixing Date:
                        indexam = url.index("aravot.am/")
                        yearstr = url[indexam+10:indexam+14]
                        monthstr = url[indexam+15:indexam+17]
                        daystr = url[indexam+18:indexam+20]
