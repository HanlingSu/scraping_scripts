...
class UpdateDB:
    ...
    def __init__(self, col_to_scrape = None,
        ...
        #self.dates = pd.date_range(start=datetime(start_year,1,1), end=datetime(2021,12,31), freq='m')
    ...
    def bdpratidincom_story(self, soup):
        """
        Function to pull the information we want from bd-pratidin.com stories
        ...
        try:
            ...
            try:
                ...
                try: 
                    maintext = soup.find("div", {"class":"amp_details"}).text
                    hold_dict['maintext'] = maintext
                except:
    ...
    def update_db(self, l, yr, mo):
        ...
        for url,id in tqdm(lines):
            ...
            if "images/" in url:
                ...
                try:
                    d['maintext'] = self.bdpratidincom_story(soup)['maintext'] #change
                    # print('Manually scraped text: ', d['maintext'][0:30],url)
                except:
                    d['maintext'] = None
                    # print('there is no text', url)
                ...
                try:
                    d['title'] = self.bdpratidincom_story(soup)['title'] #change
                    #print('The manually scraped title is ', d['title'][0:100])
                except:
                    d['title'] = None
                ...
                try:
                    d['date_publish'] = self.bdpratidincom_story(soup)['date_publish'] #change
                except:
                    d['date_publish'] = None
    ...
    def find_articles(self, url, year, month,
        ...
        query = {
                    ...
                    # 'url': {'$not': re.compile('images/', re.IGNORECASE)},
