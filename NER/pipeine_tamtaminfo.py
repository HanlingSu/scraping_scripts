...
def collect_urls_sitemap(num):  
    ...
    '''
    urls=[]
    url = f"https://www.tamtaminfo.com/wp-sitemap-posts-post-{num}.xml"
...
def collect_urls_keyword(keyword, page):
    ...
    try:
        #### change url pattern
        page_url = f'https://tamtaminfo.com/category/{keyword}/page/{page}/'
        page_req = requests.get(page_url,headers=headers)
...
def pipeline(sitemap,
    ...
    if keyword:
        ...
        keywords = [('la-lettre-de-tamtam',10),('diplomatie',4),('defense-et-securite',3),('politique',5),('societe',5),('economie',5),('international',5 ),('defense-et-securite',3),('diplomatie',3)]
