...
for i in range(5000,10550):
    numb = i
    sitemapx = "https://www.reuters.com/arc/outboundfeeds/sitemap/?outputType=xml&from=" + str(numb)
    #https://www.reuters.com/arc/outboundfeeds/sitemap/?outputType=xml&from=7700
    siteurls.append(sitemapx)
    print(sitemapx)
