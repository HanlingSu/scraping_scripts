...
This script updates themoscowtimes.com using daily sitemaps.
...
# STEP 1: Get rid of duplicates (there is no blacklist)
list_urls = list(set(urls))
print("Total number of USABLE urls found: ", len(list_urls))

# Manually check urls:
#dftest = pd.DataFrame(list_urls)  
#dftest.to_csv('/Users/diegoromero/Downloads/test_mt.csv') 
