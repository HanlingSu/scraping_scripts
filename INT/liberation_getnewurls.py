...
blpatterns = ['/checknews/', '/societe/', '/sexualite-et-genres/', '/environnement/', 'culture/', '/idees-et-debats/', '/lifestyle/', '/auteur/', '/sports/', '/cinema/', '/livres/', '/arts/', '/food/', '/images/', '/musique/', '/nytiw/', '/photographie/', '/amphtml/', '/theatre/']
clean_urls = []
for url in urls:
    if url == "":
        pass
        ...
        if url == None:
            ...
            if "liberation.fr" in url:
                ...
                try:
                    ...
                    article['source_domain'] = 'liberation.fr'
