...
# -*- coding: utf-8 -*-
"""
Script to scrape Al Jazeera articles (Jan, Feb, Mar 2025) 
...
BLACKLIST_PATTERNS = [
    "/uploads/", "/opinions/", "/sports/", "/author/", "/videos/",
    "/gallery/", "/inpictures/", "/watch/", "/shows/", "/blogs/",
    "/tag/", "/podcasts/", "/program/", "/schedule/", "/where/"
]

def get_article_urls(year, month, day):
    """Extract article URLs from Al Jazeera's daily sitemap."""
    sitemap_url = f"https://www.aljazeera.com/sitemap.xml?yyyy={year}&mm={str(month).zfill(2)}&dd={str(day).zfill(2)}"
