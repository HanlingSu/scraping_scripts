...
This script updates lefigaro.fr using weekly sitemaps (using the date of every Monday)
...
for i in range(int(daystart), int(dayend)+1):
    if i <10:
        ...
        daynum = str(i)
    url = "https://sitemaps.lefigaro.fr/lefigaro.fr/articles/" + yearn + "-" + monthn + "-" + daynum + ".xml"
