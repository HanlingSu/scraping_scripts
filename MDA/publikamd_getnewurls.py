...
base = 'https://www.publika.md/'
categories = ['politica', 'social', 'economie','romania-ue', 'externe', 'actualitate']

page_start = [1, 1, 1, 1, 1,1, 1]
page_end = [5, 12, 5, 5, 8, 5]
    ...
    if url:
        ...
        try:
            ...
            try:
                ...
                date = soup.find('time', {'class' : 'updated'})['datetime']
