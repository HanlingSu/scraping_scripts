...
direct_URLs = []
source = 'tvm.co.mz'
base = 'https://www.tvm.co.mz/index.php/noticias/'
# base = 'https://tvm.co.mz/index.php/component/k2/itemlist/category/'
category = ['nacional', 'economia', 'politica', 'educacao', 'mundo', 'saude']
# category = ['2-noticias']
...
final_result = ['https://www.tvm.co.mz' + i for i in direct_URLs]
