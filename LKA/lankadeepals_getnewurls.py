...
for url in final_result[::-1]:
    if url:
        ...
        try:
            ...
            try:
                maintext = soup.find('div', {'class' : 'header inner-content p-b-20'}).text
                ...
                try:
                    ...
                    soup.find('header', {'class' : 'post-content'})
                    article['maintext'] = soup.find('header', {'class' : 'post-content'}).text.strip()
                except:
                    article['maintext'] = article['maintext'] 
            
            if  article['maintext'][0] =='(':
